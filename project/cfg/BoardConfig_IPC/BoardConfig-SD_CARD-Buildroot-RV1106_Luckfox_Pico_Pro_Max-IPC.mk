...
export RK_PARTITION_CMD_IN_ENV="32K(env),512K@32K(idblock),256K(uboot),32M(boot),512M(oem),256M(userdata),16G(rootfs)"
...
export RK_POST_OVERLAY="overlay-luckfox-config overlay-luckfox-buildroot-shadow"
